        ...
        <div class="container position-sticky z-index-sticky top-0">
            <div class="row">
                <div class="col-12">
                    ...
                    <nav
                        class="   navbar navbar-expand-lg  blur blur-rounded top-0 z-index-fixed shadow position-absolute my-3   start-0 end-0 mx-4">
                            ...
                            <div class="collapse navbar-collapse   py-md-0 w-100" id="navigation">
                                <ul class="navbar-nav navbar-nav-hover      align-items-baseline">
                                    <li class="nav-item dropdown dropdown-hover   w-nlg-100 ">
                                        ...
                                        <div
                                            class="  dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-3   left-0 right-0  position-lg-fixed  "
                                                           ...
                                                           href="{{route('shop',['name'=>$shop->name,'id'=>$shop->id])}}">
                                                            <div class="d-flex row">
                                                                <div class=" col-3">
                                                                    ...
                                                                    <img
                                                                        onError="this.onerror=null;this.src='/img/vartashop_logo.png';this.parentElement.href='/img/noimage.png'"
                                                                        src="{{$shop->image}}"
                                                                        class="rounded-circle w-100 "
                                                                        alt="">
                                                                </div>
                                                                <div
                                                                    class="  align-items-center justify-content-between col-9">
                                                                    <div>
                                                                        <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">
                                                                            {{$shop->name}}</h6>
                                                                        <span
                                                                            class="text-sm">{{$shop->group->name??''}}</span>
                                                                    </div>
   ...
   if(document.getElementById('search-input-all').value); document.getElementById('search-form').submit();">
    ...
    <main class="py-0 mt-7  ">
        ...
        @if (session()->has('error-alert'))
            ...
            <div
                class="alert alert-danger alert-dismissible fade show top-5 left-2 z-index-3 text-right position-absolute"
                role="alert">
        ...
        @elseif (session()->has('success-alert'))
            ...
            <div
                class="alert alert-success alert-dismissible fade show top-5 left-2 z-index-3 text-right position-absolute"
                role="alert">
