@php($s1=\App\Models\Order::whereIn('shop_id',json_decode($shopIds))->where('status',1)->count())
@php($s2=\App\Models\Order::whereIn('shop_id',json_decode($shopIds))->where('status',2)->count())
@php($s3=\App\Models\Order::whereIn('shop_id',json_decode($shopIds))->where('status',3)->count())
@php($s4=\App\Models\Order::whereIn('shop_id',json_decode($shopIds))->where('status',4)->count())
            ...
            <div class="navbar-nav p-0  ">
                ...
                <a class=" nav-link hoverable-info py-2 {{str_contains( url()->full(),'my-orders/search-orders?status=2')?' active  text-primary':''}} "
                   href="{{url('panel/my-orders/search-orders?status=1')}}">
                    <i class="fa fa-plus text-primary mx-1" aria-hidden="true"></i>
                    نیاز به پردازش

                    <span class=" mx-3   p-2 badge rounded-circle bg-primary {{$s1>0?'':'d-none'}}">
                                        {{$s1}}
                                </span>
                </a>
            ...
            <div class="navbar-nav p-0  ">
                ...
                <a class=" nav-link hoverable-info py-2 {{str_contains( url()->full(),'my-orders/search-orders?status=1')?' active  text-primary':''}} "
                   href="{{url('panel/my-orders/search-orders?status=2')}}">
                    ...
                    <span class=" mx-3   p-2 badge rounded-circle bg-warning {{$s2>0?'':'d-none'}}">
                                        {{$s2}}
                                </span>
                </a>
                                ...
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <h5 class=" text-sm text-black-50 font-weight-bolder mb-0">
                                            ...
                                            <span class="text-primary text-sm font-weight-bolder"> {{$s1}}</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                    <div class="  ">
                                        <i class="fa fa-2x fa-plus text-primary m-1"
                                           aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card move-on-hover">
                        <div class="card-body p-3">
                            <div class="row">
                                ...
                                <div class="col-4 text-end">
                                    <div class="  ">
                                        <i class="fa fa-2x fa-dollar-sign text-danger m-1"
                                           aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card move-on-hover">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <h5 class="  mb-0 text-gradient-success font-weight-bold">
                                            آماده
                                            ارسال
                                        </h5>
                                        <h5 class=" text-sm text-black-50 font-weight-bolder mb-0">
                                            ...
                                            <span class="text-gradient-success text-sm font-weight-bolder"> {{$s3}}</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                    <div class="  ">
                                        <i class="fa fa-2x fa-hourglass-end text-green m-1"
                                           aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card move-on-hover">
                        <div class="card-body p-3">
                            <div class="row">
                                ...
                                <div class="col-4 text-end">
                                    <div class="  ">
                                        <i class="fa fa-2x fa-truck  text-dark m-1"
                                           aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
