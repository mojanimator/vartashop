...
@section('content')
    ...
    <div class="  bg-gray-100 mt-n7">
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-right me-3 bg-gradient-light shadow-lg"
               id="sidenav-main">
            ...
            <div class="collapse navbar-collapse px-0 w-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav p-0  ">
                    ...
                    <li class="nav-item  ">
                        <a class="nav-link  mx-1 {{str_contains( url()->current(),'/shop')?' active ':''}}"
                           href="{{url('panel/shop')}}">
                            ...
                            <span class="nav-link-text me-1">فروشگاه من</span>
                    ...
                    @if(str_contains( url()->current(),'/shop'))
                        <li class="nav-item  my-0">
                            <div class="navbar-nav p-0  ">
                                ...
                                <a class=" nav-link hoverable-info py-2 {{str_contains( url()->current(),'/shop/products')?' active ':''}} "
                                   href="{{url('panel/shop/products')}}">محصولات</a>
                        ...
                        <li class="nav-item    my-0">
                            <div class="navbar-nav p-0  ">
                                ...
                                <a class=" nav-link hoverable-info py-2 {{str_contains( url()->current(),'/shop/orders')?' active ':''}} "
                                   href="{{url('panel/shop/orders')}}">سفارشات</a>
                        ...
                        <li class="nav-item    my-0">
                            <div class="navbar-nav p-0  ">
                                ...
                                <a class=" nav-link hoverable-info py-2  {{str_contains( url()->current(),'/shop/settings')?' active ':''}} "
                                   href="{{url('panel/shop/settings')}}">تنظیمات</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{Route::is('panel.view')?'active':''}}" href="../pages/rtl.html">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
